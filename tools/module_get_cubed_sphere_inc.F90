...
!----------------------------------------------------------------------------------------
  ...
  subroutine read_netcdf_inc_new(filename, increment_data, Atm, &
    ...
    if(.not. allocated(increment_data%ua_inc)) then
      allocate(increment_data%ua_inc(is:ie,js:je,km))
      allocate(increment_data%va_inc(is:ie,js:je,km))
      allocate(increment_data%temp_inc(is:ie,js:je,km))
      allocate(increment_data%delp_inc(is:ie,js:je,km))
      allocate(increment_data%delz_inc(is:ie,js:je,km))
      allocate(increment_data%tracer_inc(is:ie,js:je,km,ntracers))
    endif
  ...
  end subroutine read_netcdf_inc_new
